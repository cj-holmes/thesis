...
%\end{equation}
%\begin{equation}
%g'\left(\theta\right)=\frac{dg}{d\theta}
%\end{equation}
%Azimuthal distortion as a function of volumetric flow rate is independent of cell depth.
%Expression (\ref{eq:phi}) is second order in $z$ and first order in $t$, so boundary conditions which determine $\phi\left(z=0,t\right)$, $\phi\left(z=d,t\right)$ and $\phi\left(z,t=0\right)$ must be provided (in physical terms, the initial rubbing direction and cell orientation is specified by the user). It can be seen that when $\theta=0$ (a homeotropically aligned cell), the equation becomes meaningless, as all terms vanish (there is no azimuthal component of the director).
%
%If we use the expressions $z=\zeta d$ and $u_{x,y} = U/d$, introducing $d$ as the cell thickness, $\zeta$ as a dimensionless parameter and $U$ as the volumetric flow rate, along with the relations,
%
%\begin{equation}
%\frac{\partial F}{\partial z} = \frac{1}{d}\frac{\partial F}{\partial \zeta}
%\label{eq:sub1}
%\end{equation}
%\begin{equation}
%\frac{\partial^2 F}{\partial z^2} = \frac{1}{d^2}\frac{\partial^2 F}{\partial \zeta^2}
%\label{eq:sub2}
%\end{equation}
%
%where $F$ is any given function, we can substitute into equation (\ref{eq:phi}) and obtain an expression for the azimuthal force balance in terms of the cell thickness.
%
%\begin{equation}
%0=g\left(\theta\right)\frac{1}{d^2}\frac{\partial^2\phi}{\partial \zeta^2} + g'\left(\theta\right)\frac{1}{d^2}\frac{\partial\theta}{\partial \zeta}\frac{\partial\phi}{\partial \zeta}-\frac{1}{2}\alpha_2\sin2\theta\left(\cos\phi\frac{1}{d^2}\frac{\partial U}{\partial \zeta}-\sin\phi\frac{1}{d^2}\frac{\partial U}{\partial \zeta}\right)
%\label{azimuthal_independent_of_d}
%\end{equation}
%
%In steady state $\left(d\phi/dt=0\right)$, the left hand side of equation (\ref{azimuthal_independent_of_d}) is set to equal 0. Now it is clear that the steady state solution for a given volumetric flow rate is independent of cell thickness, as the $1/d^2$ terms disappear.
...
%Making the same substitutions of $z=\zeta d$ and $u_{x,y} = U/d$, and using equations (\ref{eq:sub1}) and (\ref{eq:sub2}) as was done in section \ref{sec:phi}, we obtain an expression for the zenith or tilt force balance in terms of the cell thickness, $d$,
%
%\begin{eqnarray*}
%	0 & = & \left(k_{11}+\left(k_{33}-k_{11}\right)\cos^2\theta\right)\frac{1}{d^2}\frac{\partial^2\theta}{\partial \zeta^2}\\
%	& & {} + \frac{1}{2}\left(k_{11}-k_{33}\right)\sin2\theta\left(\frac{1}{d}\frac{\partial\theta}{\partial \zeta}\right)^2\\
%	& & {} + 						\frac{1}{2}g'\left(\theta\right)\left(\frac{1}{d}\frac{\partial\phi}{\partial\zeta}\right)^2+c\left(\theta\right)\left(\cos\phi\frac{1}{d^2}\frac{\partial U}{\partial \zeta}+\sin\phi\frac{1}{d^2}\frac{\partial U}{\partial \zeta}\right)
%\end{eqnarray*}
%
%Again, it is seen that the $1/d^2$ terms cancel out, leaving no dependence on cell thickness.
%
...
\begin{figure}
\begin{center}
\subfigure[Planar]{\includegraphics[width=0.5\textwidth]{Figures/conoscopy/1}}
\subfigure[Vertical]{\includegraphics[width=0.5\textwidth]{Figures/conoscopy/2}}
\subfigure[Tilted]{\includegraphics[width=0.5\textwidth]{Figures/conoscopy/3}}
\end{center}
...
&\centering{90}$^{\circ}$&\includegraphics[scale=0.1]{Figures/conoscopy/table/90_90}&\includegraphics[scale=0.1]{Figures/conoscopy/table/90_85}&\includegraphics[scale=0.1]{Figures/conoscopy/table/90_45}&\includegraphics[scale=0.1]{Figures/conoscopy/table/90_05}&\includegraphics[scale=0.1]{Figures/conoscopy/table/90_00}\\

&60$^{\circ}$&\includegraphics[scale=0.1]{Figures/conoscopy/table/60_90}&\includegraphics[scale=0.1]{Figures/conoscopy/table/60_85}&\includegraphics[scale=0.1]{Figures/conoscopy/table/60_45}&\includegraphics[scale=0.1]{Figures/conoscopy/table/60_05}&\includegraphics[scale=0.1]{Figures/conoscopy/table/60_00}\\

$\phi$&45$^{\circ}$&\includegraphics[scale=0.1]{Figures/conoscopy/table/45_90}&\includegraphics[scale=0.1]{Figures/conoscopy/table/45_85}&\includegraphics[scale=0.1]{Figures/conoscopy/table/45_45}&\includegraphics[scale=0.1]{Figures/conoscopy/table/45_05}&\includegraphics[scale=0.1]{Figures/conoscopy/table/45_00}\\

&30$^{\circ}$&\includegraphics[scale=0.1]{Figures/conoscopy/table/30_90}&\includegraphics[scale=0.1]{Figures/conoscopy/table/30_85}&\includegraphics[scale=0.1]{Figures/conoscopy/table/30_45}&\includegraphics[scale=0.1]{Figures/conoscopy/table/30_05}&\includegraphics[scale=0.1]{Figures/conoscopy/table/30_00}\\

&0$^{\circ}$&\includegraphics[scale=0.1]{Figures/conoscopy/table/00_90}&\includegraphics[scale=0.1]{Figures/conoscopy/table/00_85}&\includegraphics[scale=0.1]{Figures/conoscopy/table/00_45}&\includegraphics[scale=0.1]{Figures/conoscopy/table/00_05}&\includegraphics[scale=0.1]{Figures/conoscopy/table/00_00}\\
\end{tabular}
...
\begin{figure}
\begin{center}
\subfigure[]{\includegraphics[width=0.15\textwidth]{Figures/conoscopy/Rotate_cell/00.jpg}}
\subfigure[]{\includegraphics[width=0.15\textwidth]{Figures/conoscopy/Rotate_cell/01.jpg}}
\subfigure[]{\includegraphics[width=0.15\textwidth]{Figures/conoscopy/Rotate_cell/02.jpg}}
\subfigure[]{\includegraphics[width=0.15\textwidth]{Figures/conoscopy/Rotate_cell/03.jpg}}
\subfigure[]{\includegraphics[width=0.15\textwidth]{Figures/conoscopy/Rotate_cell/04.jpg}}
\subfigure[]{\includegraphics[width=0.15\textwidth]{Figures/conoscopy/Rotate_cell/05.jpg}}
\subfigure[]{\includegraphics[width=0.15\textwidth]{Figures/conoscopy/Rotate_cell/06.jpg}}
\subfigure[]{\includegraphics[width=0.15\textwidth]{Figures/conoscopy/Rotate_cell/07.jpg}}
\subfigure[]{\includegraphics[width=0.15\textwidth]{Figures/conoscopy/Rotate_cell/08.jpg}}
\subfigure[]{\includegraphics[width=0.15\textwidth]{Figures/conoscopy/Rotate_cell/09.jpg}}
\subfigure[]{\includegraphics[width=0.15\textwidth]{Figures/conoscopy/Rotate_cell/10.jpg}}
\subfigure[]{\includegraphics[width=0.15\textwidth]{Figures/conoscopy/Rotate_cell/11.jpg}}
\subfigure[]{\includegraphics[width=0.15\textwidth]{Figures/conoscopy/Rotate_cell/12.jpg}}
\subfigure[]{\includegraphics[width=0.15\textwidth]{Figures/conoscopy/Rotate_cell/13.jpg}}
\subfigure[]{\includegraphics[width=0.15\textwidth]{Figures/conoscopy/Rotate_cell/14.jpg}}
\subfigure[]{\includegraphics[width=0.15\textwidth]{Figures/conoscopy/Rotate_cell/15.jpg}}
\subfigure[]{\includegraphics[width=0.15\textwidth]{Figures/conoscopy/Rotate_cell/16.jpg}}
\subfigure[]{\includegraphics[width=0.15\textwidth]{Figures/conoscopy/Rotate_cell/17.jpg}}
...
\begin{figure}
\begin{center}
\subfigure[]{\includegraphics[width=0.15\textwidth]{Figures/conoscopy/Rotate_cell/modelled/cropped/01.jpg}}
\subfigure[]{\includegraphics[width=0.15\textwidth]{Figures/conoscopy/Rotate_cell/modelled/cropped/02.jpg}}
\subfigure[]{\includegraphics[width=0.15\textwidth]{Figures/conoscopy/Rotate_cell/modelled/cropped/03.jpg}}
\subfigure[]{\includegraphics[width=0.15\textwidth]{Figures/conoscopy/Rotate_cell/modelled/cropped/04.jpg}}
\subfigure[]{\includegraphics[width=0.15\textwidth]{Figures/conoscopy/Rotate_cell/modelled/cropped/05.jpg}}
\subfigure[]{\includegraphics[width=0.15\textwidth]{Figures/conoscopy/Rotate_cell/modelled/cropped/06.jpg}}
\subfigure[]{\includegraphics[width=0.15\textwidth]{Figures/conoscopy/Rotate_cell/modelled/cropped/07.jpg}}
\subfigure[]{\includegraphics[width=0.15\textwidth]{Figures/conoscopy/Rotate_cell/modelled/cropped/08.jpg}}
\subfigure[]{\includegraphics[width=0.15\textwidth]{Figures/conoscopy/Rotate_cell/modelled/cropped/09.jpg}}
\subfigure[]{\includegraphics[width=0.15\textwidth]{Figures/conoscopy/Rotate_cell/modelled/cropped/10.jpg}}
\subfigure[]{\includegraphics[width=0.15\textwidth]{Figures/conoscopy/Rotate_cell/modelled/cropped/11.jpg}}
\subfigure[]{\includegraphics[width=0.15\textwidth]{Figures/conoscopy/Rotate_cell/modelled/cropped/12.jpg}}
\subfigure[]{\includegraphics[width=0.15\textwidth]{Figures/conoscopy/Rotate_cell/modelled/cropped/13.jpg}}
\subfigure[]{\includegraphics[width=0.15\textwidth]{Figures/conoscopy/Rotate_cell/modelled/cropped/14.jpg}}
\subfigure[]{\includegraphics[width=0.15\textwidth]{Figures/conoscopy/Rotate_cell/modelled/cropped/15.jpg}}
\subfigure[]{\includegraphics[width=0.15\textwidth]{Figures/conoscopy/Rotate_cell/modelled/cropped/16.jpg}}
\subfigure[]{\includegraphics[width=0.15\textwidth]{Figures/conoscopy/Rotate_cell/modelled/cropped/17.jpg}}
\subfigure[]{\includegraphics[width=0.15\textwidth]{Figures/conoscopy/Rotate_cell/modelled/cropped/18.jpg}}
%\subfigure[]{\includegraphics[width=0.15\textwidth]{Figures/conoscopy/Rotate_cell/18.jpg}}
\end{center}
...
\begin{figure}
\begin{center}
\subfigure[]{\includegraphics[width=0.15\textwidth]{Figures/conoscopy/Stationary_cell/00.jpg}}
\subfigure[]{\includegraphics[width=0.15\textwidth]{Figures/conoscopy/Stationary_cell/01.jpg}}
\subfigure[]{\includegraphics[width=0.15\textwidth]{Figures/conoscopy/Stationary_cell/02.jpg}}
\subfigure[]{\includegraphics[width=0.15\textwidth]{Figures/conoscopy/Stationary_cell/03.jpg}}
\subfigure[]{\includegraphics[width=0.15\textwidth]{Figures/conoscopy/Stationary_cell/04.jpg}}
\subfigure[]{\includegraphics[width=0.15\textwidth]{Figures/conoscopy/Stationary_cell/05.jpg}}
\subfigure[]{\includegraphics[width=0.15\textwidth]{Figures/conoscopy/Stationary_cell/06.jpg}}
\subfigure[]{\includegraphics[width=0.15\textwidth]{Figures/conoscopy/Stationary_cell/07.jpg}}
\subfigure[]{\includegraphics[width=0.15\textwidth]{Figures/conoscopy/Stationary_cell/08.jpg}}
\subfigure[]{\includegraphics[width=0.15\textwidth]{Figures/conoscopy/Stationary_cell/09.jpg}}
\end{center}
...
\begin{figure}
\begin{center}
\subfigure[]{\includegraphics[width=0.15\textwidth]{Figures/conoscopy/Stationary_cell/modelled/cropped/00.jpg}}
\subfigure[]{\includegraphics[width=0.15\textwidth]{Figures/conoscopy/Stationary_cell/modelled/cropped/01.jpg}}
\subfigure[]{\includegraphics[width=0.15\textwidth]{Figures/conoscopy/Stationary_cell/modelled/cropped/02.jpg}}
\subfigure[]{\includegraphics[width=0.15\textwidth]{Figures/conoscopy/Stationary_cell/modelled/cropped/03.jpg}}
\subfigure[]{\includegraphics[width=0.15\textwidth]{Figures/conoscopy/Stationary_cell/modelled/cropped/04.jpg}}
\subfigure[]{\includegraphics[width=0.15\textwidth]{Figures/conoscopy/Stationary_cell/modelled/cropped/05.jpg}}
\subfigure[]{\includegraphics[width=0.15\textwidth]{Figures/conoscopy/Stationary_cell/modelled/cropped/06.jpg}}
\subfigure[]{\includegraphics[width=0.15\textwidth]{Figures/conoscopy/Stationary_cell/modelled/cropped/07.jpg}}
\subfigure[]{\includegraphics[width=0.15\textwidth]{Figures/conoscopy/Stationary_cell/modelled/cropped/08.jpg}}
\subfigure[]{\includegraphics[width=0.15\textwidth]{Figures/conoscopy/Stationary_cell/modelled/cropped/09.jpg}}
\end{center}
...
\begin{figure}
\begin{center}
\subfigure[]{\includegraphics[width=0.17\textwidth]{Figures/conoscopy/Planar_thickness/0}}
\subfigure[]{\includegraphics[width=0.17\textwidth]{Figures/conoscopy/Planar_thickness/1.jpg}}
\subfigure[]{\includegraphics[width=0.17\textwidth]{Figures/conoscopy/Planar_thickness/2.jpg}}
\subfigure[]{\includegraphics[width=0.17\textwidth]{Figures/conoscopy/Planar_thickness/3.jpg}}
\subfigure[]{\includegraphics[width=0.17\textwidth]{Figures/conoscopy/Planar_thickness/4.jpg}}
\subfigure[]{\includegraphics[width=0.17\textwidth]{Figures/conoscopy/Planar_thickness/5.jpg}}
\subfigure[]{\includegraphics[width=0.17\textwidth]{Figures/conoscopy/Planar_thickness/6.jpg}}
\end{center}
...
\begin{figure}
\begin{center}
\subfigure[]{\includegraphics[width=0.2\textwidth]{Figures/conoscopy/homeotropic/00.jpg}}
\subfigure[]{\includegraphics[width=0.2\textwidth]{Figures/conoscopy/homeotropic/01.jpg}}\\
\subfigure[]{\includegraphics[width=0.2\textwidth]{Figures/conoscopy/homeotropic/03.jpg}}
\subfigure[]{\includegraphics[width=0.2\textwidth]{Figures/conoscopy/homeotropic/04.jpg}}
\end{center}
...
\begin{figure}
\begin{center}
\subfigure[]{\includegraphics[width=0.2\textwidth]{Figures/conoscopy/polarisers/00.jpg}}
\subfigure[]{\includegraphics[width=0.2\textwidth]{Figures/conoscopy/polarisers/01.jpg}}\\
\subfigure[]{\includegraphics[width=0.2\textwidth]{Figures/conoscopy/polarisers/02.jpg}}
\subfigure[]{\includegraphics[width=0.2\textwidth]{Figures/conoscopy/polarisers/03.jpg}}
\end{center}
...
\section{Tracking conoscopic figure alignment}
...
\begin{figure}
\begin{center}
\subfigure[Original]{\includegraphics[width=0.18\textwidth]{Figures/Mirror/bob}}\hspace{0.4cm}
\subfigure[Smoothed]{\includegraphics[width=0.18\textwidth]{Figures/Mirror/bobsmooth}}\\
\scalebox{0.9}[1]{\subfigure[]{\includegraphics[width=0.25\textwidth]{Figures/Mirror/1}}}
\scalebox{0.9}[1]{\subfigure[]{\includegraphics[width=0.25\textwidth]{Figures/Mirror/2}}}\\
\scalebox{0.9}[1]{\subfigure[]{\includegraphics[width=0.25\textwidth]{Figures/Mirror/3}}}
\scalebox{0.9}[1]{\subfigure[]{\includegraphics[width=0.25\textwidth]{Figures/Mirror/4}}}\\
\scalebox{0.9}[1]{\subfigure[]{\includegraphics[width=0.25\textwidth]{Figures/Mirror/5}}}
\scalebox{0.9}[1]{\subfigure[]{\includegraphics[width=0.25\textwidth]{Figures/Mirror/6}}}\\
\scalebox{0.9}[1]{\subfigure[]{\includegraphics[width=0.25\textwidth]{Figures/Mirror/9}}}
\scalebox{0.9}[1]{\subfigure[]{\includegraphics[width=0.25\textwidth]{Figures/Mirror/10}}}
\end{center}
...
\begin{figure}
\begin{center}
\subfigure[]{\includegraphics[width=0.25\textwidth]{Figures/45/collar_photo}}\hspace{0.5in}
\subfigure[]{\includegraphics[width=0.25\textwidth]{Figures/45/collar}}
\end{center}
