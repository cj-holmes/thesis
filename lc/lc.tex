\chapter{The Liquid Crystalline phase of matter} 
...
\begin{figure}
\begin{center}
\subfigure[Isotropic fluid]{\includegraphics[width=0.35\textwidth]{figures/introduction/isotropic_phase}}\hspace{0.5cm}
\subfigure[Nematic phase]{\includegraphics[width=0.35\textwidth]{figures/introduction/nematic_phase}}\hspace{0.5cm}
\subfigure[Smectic A phase]{\includegraphics[width=0.35\textwidth]{figures/introduction/smectic_phase}}\hspace{0.5cm}
\subfigure[Solid Crystalline]{\includegraphics[width=0.35\textwidth]{figures/introduction/crystal_phase}}\hspace{0.5cm}
\end{center}
...
\begin{figure}
\begin{center}
\subfigure[Splay]{\includegraphics[width=0.28\textwidth]{figures/introduction/splay}}\hspace{0.2cm}
\subfigure[Twist]{\includegraphics[width=0.28\textwidth]{figures/introduction/twist}}\hspace{0.2cm}
\subfigure[Bend]{\includegraphics[width=0.28\textwidth]{figures/introduction/bend}}\hspace{0.2cm}
\end{center}
...
\begin{figure}
\begin{center}
\subfigure[Planar]{\includegraphics[width=0.35\textwidth]{figures/introduction/planar}}
\subfigure[Vertical]{\includegraphics[width=0.35\textwidth]{figures/introduction/vertical}}
\subfigure[Tilted]{\includegraphics[width=0.35\textwidth]{figures/introduction/tilted}}
\end{center}
...
\begin{figure}
\begin{center}
\subfigure[$\eta_1$]{\includegraphics[width=0.21\textwidth]{figures/introduction/eta1}}\hspace{0.5cm}
\subfigure[$\eta_2$]{\includegraphics[width=0.21\textwidth]{figures/introduction/eta2}}\hspace{0.5cm}
\subfigure[$\eta_3$]{\includegraphics[width=0.21\textwidth]{figures/introduction/eta3}}\hspace{0.5cm}
\end{center}
