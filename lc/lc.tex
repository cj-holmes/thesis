...
\begin{figure}
\begin{center}
\subfigure[$\eta_1$]{\includegraphics[width=0.15\textwidth]{figures/introduction/eta1}}
\subfigure[$\eta_2$]{\includegraphics[width=0.15\textwidth]{figures/introduction/eta2}}
\subfigure[$\eta_3$]{\includegraphics[width=0.15\textwidth]{figures/introduction/eta3}}
\end{center}
